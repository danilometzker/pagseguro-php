  ...
  5. Credit Card
	...
	*/
	public function CreditCardPayment(		
		...
		$credit_card_name,		// Credit card name, e.g DANILO R M CARDOSO
		$credit_card_cpf, 		// Credit card cpf, e.g: 03784722245
		$credit_card_birthdate,	// Credit card birthdate, e.g: 05/11/1998
		$credit_card_areacode,	// Credit card areacode, e.g: 92
		$credit_card_phone,		// Credit card phone, e.g: 991278199
		$payment_reference 		// Payment reference, e.g: ARITMO00001
		){
